    ...
    <div style="display: flex; flex-direction: column; gap: 16px; height: 100%; min-height: 0;">
      ...
      <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 14px; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 0;">
          <div style="font-size: clamp(26px, 5vw, 32px); font-weight: 900; color: var(--primary); margin-bottom: 6px; white-space: nowrap;">₦${Number(listing.price || 0).toLocaleString()}</div>
          <h2 style="font-size: clamp(17px, 3.5vw, 21px); font-weight: 800; margin: 0 0 6px; overflow-wrap: anywhere; word-break: break-word; line-height: 1.4; color: var(--text);">${escapeHtml(listing.title)}</h2>
