...
/* =========================================================
   ...
   These limits reduce the initial documents loaded by realtime
   listeners while preserving the same page/listener architecture.
   Notifications remain at 50 so the existing unread badge does not
   become artificially capped by a smaller window.
   ========================================================= */

const HOME_POST_LIMIT = 25;
const CHAT_CONVERSATION_LIMIT = 30;
const MARKET_LISTING_LIMIT = 30;
const TIMETRUST_SKILL_LIMIT = 30;
const TIMETRUST_REQUEST_LIMIT = 30;
