...
​message.innerHTML = <div class="status success" style="margin-bottom: 14px;"> <strong>Reset link sent 📧</strong><br><br> We've sent a password reset link to your email address. Check your inbox and follow the instructions to choose a new password. </div>;
...
​${countries
.map(
c => <button class="country-option" data-country="${c[0]}" > ${escapeHtml( c[1] )} </button>
)
.join("")}
​</div>
​<div
